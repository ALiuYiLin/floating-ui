...
import {arrow, autoPlacement, hide, offset, shift} from '@floating-ui/dom';
import type {Middleware, Placement} from '@floating-ui/dom';

import {FloatingArrow, useFloating} from '../../../src';
...
const Demo = defineComponent(function (props: {
  placement?: Placement;
  arrowProps?: any;
  floatingStyle?: any;
  floatingProps?: any;
  ...
  const {floatingStyles, placement, middlewareData, refs, context} = useFloating({
  ...
  const edgeAlignment = props.placement?.split('-')[1];
